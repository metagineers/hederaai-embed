...
GHPAT_TOKEN = os.getenv("GHPAT_TOKEN")
...
async def add_data_source(data_source: DataSourceModel, response: Response):
    ...
    try:
        ...
        if data_type == "github":
            ...
            # repo:hedera-dev/cra-hedera-dapp-template type:repo
            ec_app.add(source=data_value, metadata=metadata, data_type="github", loader=loader)
        else:
            ec_app.add(**params)
